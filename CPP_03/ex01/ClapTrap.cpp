...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/22 10:05:59 by fbasso            #+#    #+#             */
/*   Updated: 2021/10/22 10:05:59 by fbasso           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " << this->_name << " attacks " << target << " causing " << this->_attack_damage << " of damage."<< std::endl; 
}
